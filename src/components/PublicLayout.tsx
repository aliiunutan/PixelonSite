...
import { Camera, User, LogIn, Menu, X, Palette } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight">Pixelon Medya</span>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-4">
              <div className="group relative">
                ...
                <div className="absolute right-0 mt-2 w-40 bg-white border border-slate-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all p-2">
                  <p className="text-xs font-semibold text-slate-400 mb-2 px-2">Tema Rengi</p>
